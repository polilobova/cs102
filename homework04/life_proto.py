...
class GameOfLife:
    ...
    def get_neighbours(self, cell: Cell) -> Cells:
        ...
        for i in range(-1, 2):
            for j in range(-1, 2):
                ...
                if i == 0 and j == 0:
                    continue
                if self.cell_width > x > -1 and self.cell_height > y > -1:
    ...
    def get_next_generation(self) -> Grid:
        ...
        for y in range(self.cell_height):
            for x in range(self.cell_width):
                cell = (y, x)
                count_neighbours = sum(self.get_neighbours(cell))
                if count_neighbours in (2, 3) and self.grid[y][x] == 1:
                    new_grid[y][x] = 1
                elif count_neighbours == 3 and self.grid[y][x] == 0:
                    new_grid[y][x] = 1
                else:
                    new_grid[y][x] = 0
        return new_grid
